%% Derived approach from the book, but with 9x9.
%% Could write a method to automatically adapt to the sudoku size,
%% but that goes against the sheer simplicity of this approach.
